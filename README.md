#  你好，我是 simimasai111！欢迎来到我的数字宇宙 🌌

![Profile Views](https://komarev.com/ghpvc/?username=simimasai111&color=ff69b4&style=flat-square&label=Profile+Views)

---

### 🚀 关于我 | About Me
-  **热爱探索**：热衷于编程、逆向工程与 CTF 竞赛，喜欢拆解未知。
- 🔒 **安全极客**：持续关注信息安全与隐私保护，守护数字世界的边界。
- 🌱 **终身学习**：每天都在吸收新知识，保持对技术的好奇心。
-  **终极目标**：用代码构建更高效、更安全的数字世界！
...
> ✨ **座右铭**：*在代码的星辰大海中，保持敬畏，保持狂热。* 🌠

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=100&section=footer&text=Thanks+for+visiting!&fontSize=30&animation=fadeIn" />
</p>
